...
#######################################################################
# Model
path = 'pretrained_weights/InternVL2_5-4B/'
pretrained_pth = None

# Output Directory
work_dir = "ReVIOSa/TRAIN/reviosa_4b_interrvos"
...
### INTERRVOS DATASET
data_root = 'datasets/InterRVOS/train/'
interrvos_image_folder = data_root + 'JPEGImages'
interrvos_expression_file = data_root + 'meta_expressions.json'
interrvos_mask_file = data_root + 'mask_dict.json'

interrvos_dataset = dict(
    type=VideoInterRVOSDataset,
    image_folder=interrvos_image_folder,
    expression_file=interrvos_expression_file,
    mask_file=interrvos_mask_file,
    tokenizer=tokenizer,
