...
def eval_queue(q, rank, out_dict, progress_counter):
    while not q.empty():
        ...
        for frame_idx, frame_name in enumerate(vid['frames']):
            ...
            pred_mask = cocomask.decode(pred['prediction_masks_tar'][frame_idx])
