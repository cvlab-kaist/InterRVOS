...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_dir", type=str, default="mevis/valid_u")
    ...
    output_dict_copy = dict(output_dict)
    output_dict_copy["final"] = {
    ...
    with open(args.save_path, 'w') as file:
        json.dump(output_dict_copy, file, indent=4)
